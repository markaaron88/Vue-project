<template>
  <div class="menu_wrapper">
    <div class="menu">
      <h3>~ Authentic handmade burritos~</h3>
      <img src="../assets/images/burrito.png" alt="devliery_pic" />
...
export default {
  ...
  methods: {
    async addToBasket(item, option) {
      const pizzaExits = await this.basket.find(
    ...
    addNewOrder() {
      const order = {
        burritos: { ...this.basket },
        createdAt: new Date(),
      };

      store.dispatch("addNewOrder", order);
      this.basket = [];
      this.basketText = "Thank you , your ordered has been placed.";
    },
  },
};
</script>
